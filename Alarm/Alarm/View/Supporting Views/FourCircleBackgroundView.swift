    ...
    var body: some View {
        ZStack {
            GeometryReader { geo in
                let maxX: CGFloat = geo.size.width
                let maxY: CGFloat = geo.size.height
                let maxSize: CGFloat = geo.size.width * 0.4
                let minSize: CGFloat = geo.size.width * 0.05
